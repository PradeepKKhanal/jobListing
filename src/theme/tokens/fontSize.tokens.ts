export const FONT_SIZE_TOKEN = {
    ...
    sm: {
        value: '14px', // Small font size for small paragraphs or captions
    },
    md: {
    ...
    '2xl': {
        value: '30px', // 2x large font size for subheadings or prominent titles
    },
    '3xl': {
        value: '36px', // 3x large font size for main headings (H1)
    },
};
